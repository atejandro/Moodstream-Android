...
public class CreateEventActivity extends SherlockActivity implements OnMapLongClickListener, LocationListener,
...
GooglePlayServicesClient.OnConnectionFailedListener{
	...
	*/
	...
	public void onMapLongClick(LatLng point) {
		...
		circleOption=new CircleOptions().center(point)
				.radius(150).fillColor(0x40ff0000).
	...
	public void onConnected(Bundle arg0) {
		getCurrentLocation();
		animateMapTo(new LatLng(mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude()));
	}
  ...
  */
    ...
    public void getCurrentLocation() {
        ...
        if (servicesConnected()) {
        	...
        	Log.d(TAG,"Trying to get last loctaion...");
	...
	private void animateMapTo(LatLng newLocation) {
		INIT=new CameraPosition.Builder().target(newLocation).zoom((15.5F)).bearing(0).tilt(70F).build();
        mMap.animateCamera(CameraUpdateFactory.newCameraPosition(INIT));
	}
	
	//_____________________________________________________________________________
	//LOCATION SERVICES____________________________________________________________
    /**
  ...
  //ASYNC TASKS___________________________________________________________
	...
	//_____________________________________________________________________________
	//ERROR DIALOG CLASS___________________________________________________________
	/**
