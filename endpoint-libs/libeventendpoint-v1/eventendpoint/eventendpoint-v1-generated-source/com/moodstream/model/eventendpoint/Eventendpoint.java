 ...
 * on 2013-10-31 at 01:33:39 UTC 
 * Modify at your own risk.
 */

package com.moodstream.model.eventendpoint;
...
public class Eventendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.15.0-rc of the eventendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class GetEvent extends EventendpointRequest<com.moodstream.model.eventendpoint.model.Event> {
    ...
    protected GetEvent(java.lang.Long id) {
      super(Eventendpoint.this, "GET", REST_PATH, null, com.moodstream.model.eventendpoint.model.Event.class);
   ...
   * operation.
   *
   * @param content the {@link com.moodstream.model.eventendpoint.model.Event}
   * @return the request
   */
  public InsertEvent insertEvent(com.moodstream.model.eventendpoint.model.Event content) throws java.io.IOException {
    InsertEvent result = new InsertEvent(content);
    initialize(result);
    return result;
  }

  public class InsertEvent extends EventendpointRequest<com.moodstream.model.eventendpoint.model.Event> {
     ...
     * @since 1.13
     */
    protected InsertEvent(com.moodstream.model.eventendpoint.model.Event content) {
      super(Eventendpoint.this, "POST", REST_PATH, content, com.moodstream.model.eventendpoint.model.Event.class);
    }
  ...
  /**
   * Create a request for the method "inviteFriend".
   *
   * This request holds the parameters needed by the the eventendpoint server.  After setting any
   * optional parameters, call the {@link InviteFriend#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @param invitee
   * @return the request
   */
  public InviteFriend inviteFriend(java.lang.Long id, java.lang.String invitee) throws java.io.IOException {
    InviteFriend result = new InviteFriend(id, invitee);
    initialize(result);
    return result;
  }

  public class InviteFriend extends EventendpointRequest<Void> {

    private static final String REST_PATH = "inviteFriend/{id}/{invitee}";
     ...
     * optional parameters, call the {@link InviteFriend#execute()} method to invoke the remote
     * operation. <p> {@link
     * InviteFriend#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param id
     * @param invitee
     * @since 1.13
     */
    protected InviteFriend(java.lang.Long id, java.lang.String invitee) {
      super(Eventendpoint.this, "POST", REST_PATH, null, Void.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      this.invitee = com.google.api.client.util.Preconditions.checkNotNull(invitee, "Required parameter invitee must be specified.");
    }

    @Override
    public InviteFriend setAlt(java.lang.String alt) {
      return (InviteFriend) super.setAlt(alt);
    }

    @Override
    public InviteFriend setFields(java.lang.String fields) {
      return (InviteFriend) super.setFields(fields);
    }

    @Override
    public InviteFriend setKey(java.lang.String key) {
      return (InviteFriend) super.setKey(key);
    }

    @Override
    public InviteFriend setOauthToken(java.lang.String oauthToken) {
      return (InviteFriend) super.setOauthToken(oauthToken);
    }

    @Override
    public InviteFriend setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (InviteFriend) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public InviteFriend setQuotaUser(java.lang.String quotaUser) {
      return (InviteFriend) super.setQuotaUser(quotaUser);
    }

    @Override
    public InviteFriend setUserIp(java.lang.String userIp) {
      return (InviteFriend) super.setUserIp(userIp);
    }
    ...
    public InviteFriend setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
    ...
    public InviteFriend setInvitee(java.lang.String invitee) {
      this.invitee = invitee;
      return this;
    }

    @Override
    public InviteFriend set(String parameterName, Object value) {
      return (InviteFriend) super.set(parameterName, value);
    }
  }
  ...
  public class ListEvent extends EventendpointRequest<com.moodstream.model.eventendpoint.model.CollectionResponseEvent> {
     ...
     */
    protected ListEvent() {
      super(Eventendpoint.this, "GET", REST_PATH, null, com.moodstream.model.eventendpoint.model.CollectionResponseEvent.class);
    }
    ...
    public ListEvent setNickname(java.lang.String nickname) {
   ...
   * @return the request
   */
  public UpdateEvent updateEvent(com.moodstream.model.eventendpoint.model.Event content) throws java.io.IOException {
    UpdateEvent result = new UpdateEvent(content);
    initialize(result);
    return result;
  }

  public class UpdateEvent extends EventendpointRequest<com.moodstream.model.eventendpoint.model.Event> {
     ...
     * @since 1.13
     */
    protected UpdateEvent(com.moodstream.model.eventendpoint.model.Event content) {
      super(Eventendpoint.this, "PUT", REST_PATH, content, com.moodstream.model.eventendpoint.model.Event.class);
    }
