 ...
 * on 2013-10-31 at 01:32:46 UTC 
 * Modify at your own risk.
 */

package com.moodstream.model.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.15.0-rc of the userendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class AddFriend extends UserendpointRequest<Void> {
    ...
    protected AddFriend(java.lang.String userId, java.lang.String friendId) {
      super(Userendpoint.this, "POST", REST_PATH, null, Void.class);
  ...
  public class GetUser extends UserendpointRequest<com.moodstream.model.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.String id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.moodstream.model.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.moodstream.model.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.moodstream.model.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.moodstream.model.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.moodstream.model.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.moodstream.model.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.moodstream.model.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.moodstream.model.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.moodstream.model.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.moodstream.model.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.moodstream.model.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.moodstream.model.userendpoint.model.User.class);
    }
